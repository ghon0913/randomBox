...
public class OrderInfoDTO {
	...
	public String toString() {
		return "OrderInfoDTO [num=" + num + ", userId=" + userId + ", orderName=" + orderName + ", phone=" + phone
				...
				+ payMethod + ", orderDay=" + orderDay + ", sellerId=" + sellerId + ", getNum()=" + getNum()
				+ ", getUserId()=" + getUserId() + ", getOrderName()=" + getOrderName() + ", getPhone()=" + getPhone()
				+ ", geteMail()=" + geteMail() + ", getPost1()=" + getPost1() + ", getPost2()=" + getPost2()
				+ ", getAddr1()=" + getAddr1() + ", getAddr2()=" + getAddr2() + ", getgCode()=" + getgCode()
				+ ", getgName()=" + getgName() + ", getgPrice()=" + getgPrice() + ", getgImage()=" + getgImage()
				+ ", getPayMethod()=" + getPayMethod() + ", getOrderDay()=" + getOrderDay() + ", getSellerId()="
				+ getSellerId() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
